                ...
                <div class="cart-group divide pr" :data-productid="item.goods_id">
                  <div class="cart-top-items">
                    <div class="cart-items clearfix">
                      ...
                      <!--删除按钮-->
                      <div class="operation">
                        <a class="items-delete-btn" @click="cartdel(item.rec_id)"></a>
                      </div>
                      <!--商品数量-->
                      <div>
                        <!--总价格-->
                        <div class="subtotal" style="font-size: 14px">¥ {{(+item.shop_price * item.goods_number).toFixed(2)}}</div>
                        <!--数量-->
                        <buy-num :num="+item.goods_number"
                                 :id="item.goods_id"
                        ...
                        <!--价格-->
                        <div class="price1">¥ {{item.shop_price}}</div>
                      </div>
                    </div>
                  </div>
                </div>
